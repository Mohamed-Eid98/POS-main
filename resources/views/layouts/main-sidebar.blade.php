        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'chart-flot')) }}"> الفواتير المدفوعه</a>
                    </li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'chart-chartjs')) }}">الفواتيرالغيرمدفوعه
                        </a></li>
                </ul>
            </li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'cards')) }}">العملاء </a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'darggablecards')) }}"> زبائن العملاء</a>
                    </li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ route('product.add') }}"> اضافه منتج</a>
                    <li><a class="slide-item" href="{{ route('product.show') }}"> عرض المنتجات</a>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">القسم الرئيسي</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('category.add') }}"> اضافه قسم</a></li>
                    <li><a class="slide-item" href="{{ route('category.show') }}"> عرض القسم</a>
                    </li>
                </ul>
            </li>
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">القسم الفرعي</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('subcategory.add') }}"> اضافه قسم فرعي</a></li>
                    <li><a class="slide-item" href="{{ route('subcategory.show') }}"> عرض الاقسام الفرعيه</a>
                    </li>
                </ul>
            </li>
        </ul>
